...
var G__57264 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__57264,"id",id);

goog.dom.appendChild(document.body,G__57264);
...
var G__57266 = document.createElement("div");
com.fulcrologic.fulcro.inspect.element_picker.goog$module$goog$object.set(G__57266,"id",id);

goog.dom.appendChild(document.body,G__57266);
...
var temp__5751__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57269_SHARP_){
return ((clojure.string.starts_with_QMARK_(p1__57269_SHARP_,"__reactInternalInstance$")) || (clojure.string.starts_with_QMARK_(p1__57269_SHARP_,"__reactFiber$")));
...
com.fulcrologic.fulcro.inspect.element_picker.pick_element = (function com$fulcrologic$fulcro$inspect$element_picker$pick_element(p__57274){
var map__57275 = p__57274;
var map__57275__$1 = cljs.core.__destructure_map(map__57275);
var on_pick = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__57275__$1,new cljs.core.Keyword(null,"on-pick","on-pick",-1995648316),cljs.core.identity);
...
var instance = (function (){var G__57283 = target__$1;
if((G__57283 == null)){
return null;
} else {
return com.fulcrologic.fulcro.inspect.element_picker.react_instance(G__57283);
}
})();
...
var G__57311 = goog.dom.getParentElement(target__$1);
target__$1 = G__57311;
continue;
}
} else {
...
var G__57293_57312 = cljs.core.deref(current);
(on_pick.cljs$core$IFn$_invoke$arity$1 ? on_pick.cljs$core$IFn$_invoke$arity$1(G__57293_57312) : on_pick.call(null,G__57293_57312));
...
var state_map = (function (){var G__57301 = com.fulcrologic.fulcro.components.any__GT_app(comp);
var G__57301__$1 = (((G__57301 == null))?null:new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366).cljs$core$IFn$_invoke$arity$1(G__57301));
if((G__57301__$1 == null)){
return null;
} else {
return cljs.core.deref(G__57301__$1);
}
})();
...
}catch (e57302){var _ = e57302;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","static-query","fulcro.inspect.ui.element/static-query",1120589305),(function (){try{var G__57306 = comp;
var G__57306__$1 = (((G__57306 == null))?null:com.fulcrologic.fulcro.components.react_type(G__57306));
if((G__57306__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$1(G__57306__$1);
}
}catch (e57305){var _ = e57305;
return null;
}})(),new cljs.core.Keyword("fulcro.inspect.ui.element","query","fulcro.inspect.ui.element/query",113020567),(function (){try{var G__57308 = comp;
var G__57308__$1 = (((G__57308 == null))?null:com.fulcrologic.fulcro.components.react_type(G__57308));
if((G__57308__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.components.get_query.cljs$core$IFn$_invoke$arity$2(G__57308__$1,state_map);
}
}catch (e57307){var _ = e57307;
return null;
}})()], null);
});
/**
...
var app_uuid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57309__$1,new cljs.core.Keyword("fulcro.inspect.core","app-uuid","fulcro.inspect.core/app-uuid",-1096445491));
