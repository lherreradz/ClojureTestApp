...
var i_49739 = (self__.level + (1));
while(true){
if((i_49739 <= (new_level + (1)))){
(update[i_49739] = self__.header);

var G__49740 = (i_49739 + (1));
i_49739 = G__49740;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_49743 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_49743[i]));
} else {
x__$2.forward.push((((i < links_49743.length))?(links_49743[i]):null));
}

if((i < links_49743.length)){
(links_49743[i] = x__$2);
} else {
links_49743.push(x__$2);
}
...
var i_49751 = (0);
while(true){
if((i_49751 <= self__.level)){
var links_49752 = (update[i_49751]).forward;
if((x__$1 === (((i_49751 < links_49752.length))?(links_49752[i_49751]):null))){
(links_49752[i_49751] = (x__$1.forward[i_49751]));

var G__49755 = (i_49751 + (1));
i_49751 = G__49755;
continue;
} else {
var G__49756 = (i_49751 + (1));
i_49751 = G__49756;
continue;
}
} else {
...
var G__49763 = nx;
var G__49764 = (level__$1 - (1));
x = G__49763;
level__$1 = G__49764;
continue;
} else {
var G__49765 = x;
var G__49766 = (level__$1 - (1));
x = G__49765;
level__$1 = G__49766;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__49769 = nx;
var G__49770 = (level__$1 - (1));
x = G__49769;
level__$1 = G__49770;
continue;
} else {
var G__49771 = x;
var G__49772 = (level__$1 - (1));
x = G__49771;
level__$1 = G__49772;
continue;
}
