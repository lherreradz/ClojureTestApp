...
var G__44479 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__44479;
continue;
} else {
return ch;
...
var vec__44436 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44436,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq44471){
var G__44472 = cljs.core.first(seq44471);
var seq44471__$1 = cljs.core.next(seq44471);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44472,seq44471__$1);
}));
...
var G__44493__i = 0, G__44493__a = new Array(arguments.length -  1);
while (G__44493__i < G__44493__a.length) {G__44493__a[G__44493__i] = arguments[G__44493__i + 1]; ++G__44493__i;}
  _ = new cljs.core.IndexedSeq(G__44493__a,0,null);
} 
return G__44488__delegate.call(this,rdr,_);};
G__44488.cljs$lang$maxFixedArity = 1;
G__44488.cljs$lang$applyTo = (function (arglist__44494){
var rdr = cljs.core.first(arglist__44494);
var _ = cljs.core.rest(arglist__44494);
