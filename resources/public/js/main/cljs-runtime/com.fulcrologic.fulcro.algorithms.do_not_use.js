...
var vec__55452 = ((cljs.core.seq_QMARK_(expr))?cljs.core.ffirst(expr):cljs.core.first(expr));
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55452,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55452,(1),null);
...
var expr__$1 = (function (){var G__55462 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__55462);
} else {
return G__55462;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__55463 = cljs.core.first(expr);
return (com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro.algorithms.do_not_use.join_key.cljs$core$IFn$_invoke$arity$1(G__55463) : com.fulcrologic.fulcro.algorithms.do_not_use.join_key.call(null,G__55463));
} else {
return expr;
...
var len__4864__auto___55507 = arguments.length;
var i__4865__auto___55508 = (0);
while(true){
if((i__4865__auto___55508 < len__4864__auto___55507)){
args__4870__auto__.push((arguments[i__4865__auto___55508]));

var G__55509 = (i__4865__auto___55508 + (1));
i__4865__auto___55508 = G__55509;
continue;
} else {
}
break;
...
/** @this {Function} */
(com.fulcrologic.fulcro.algorithms.do_not_use.deep_merge.cljs$lang$applyTo = (function (seq55467){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55467));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [["The composed root query is not valid EQL. The app may crash. See `(comp/get-query ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__55494 = query;
var G__55494__$1 = (((G__55494 == null))?null:cljs.core.meta(G__55494));
var G__55494__$2 = (((G__55494__$1 == null))?null:new cljs.core.Keyword(null,"component","component",1555936782).cljs$core$IFn$_invoke$arity$1(G__55494__$1));
if((G__55494__$2 == null)){
return null;
} else {
return (component_name_fn.cljs$core$IFn$_invoke$arity$1 ? component_name_fn.cljs$core$IFn$_invoke$arity$1(G__55494__$2) : component_name_fn.call(null,G__55494__$2));
}
})()),")`"].join(''),query], null);
}),null)),null,587328132,null);
} else {
}
