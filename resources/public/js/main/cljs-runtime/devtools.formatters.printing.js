...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42537){
var G__42538 = cljs.core.first(seq42537);
var seq42537__$1 = cljs.core.next(seq42537);
var G__42539 = cljs.core.first(seq42537__$1);
var seq42537__$2 = cljs.core.next(seq42537__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42538,G__42539,seq42537__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42583_SHARP_){
return (!((cljs.core.meta(p1__42583_SHARP_) == null)));
})))){
...
var map__42681 = opts;
var map__42681__$1 = cljs.core.__destructure_map(map__42681);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42681__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42682){var _e__40685__auto__ = e42682;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e42684){var _e__40685__auto__ = e42684;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42686 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42687 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42687);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42688__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42686);
}});
...
var temp__5751__auto___42818 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___42818)){
var managed_print_level_42819 = temp__5751__auto___42818;
var _STAR_print_level_STAR__orig_val__42702_42820 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42703_42821 = managed_print_level_42819;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42703_42821);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42689_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42689_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42702_42820);
}} else {
job_fn();
}
