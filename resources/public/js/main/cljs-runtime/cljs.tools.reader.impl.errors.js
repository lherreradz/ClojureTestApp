...
var i__4865__auto___44405 = (0);
while(true){
if((i__4865__auto___44405 < len__4864__auto___44404)){
args__4870__auto__.push((arguments[i__4865__auto___44405]));

var G__44406 = (i__4865__auto___44405 + (1));
i__4865__auto___44405 = G__44406;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq44220){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44221,G__44222,seq44220__$2);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___44407 = arguments.length;
var i__4865__auto___44408 = (0);
while(true){
if((i__4865__auto___44408 < len__4864__auto___44407)){
args__4870__auto__.push((arguments[i__4865__auto___44408]));

var G__44409 = (i__4865__auto___44408 + (1));
i__4865__auto___44408 = G__44409;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq44225){
var G__44226 = cljs.core.first(seq44225);
var seq44225__$1 = cljs.core.next(seq44225);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44226,seq44225__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq44229){
var G__44230 = cljs.core.first(seq44229);
var seq44229__$1 = cljs.core.next(seq44229);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44230,seq44229__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___44413 = arguments.length;
var i__4865__auto___44414 = (0);
while(true){
if((i__4865__auto___44414 < len__4864__auto___44413)){
args__4870__auto__.push((arguments[i__4865__auto___44414]));

var G__44415 = (i__4865__auto___44414 + (1));
i__4865__auto___44414 = G__44415;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq44231){
var G__44232 = cljs.core.first(seq44231);
var seq44231__$1 = cljs.core.next(seq44231);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44232,seq44231__$1);
}));
...
var G__44423 = (i__4865__auto___44422 + (1));
i__4865__auto___44422 = G__44423;
continue;
} else {
}
break;
...
var init = (function (){var G__44282 = kind;
var G__44282__$1 = (((G__44282 instanceof cljs.core.Keyword))?G__44282.fqn:null);
switch (G__44282__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44282__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq44271){
var G__44272 = cljs.core.first(seq44271);
var seq44271__$1 = cljs.core.next(seq44271);
var G__44273 = cljs.core.first(seq44271__$1);
var seq44271__$2 = cljs.core.next(seq44271__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44272,G__44273,seq44271__$2);
}));
...
var iter__4652__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__44365(s__44366){
return (new cljs.core.LazySeq(null,(function (){
var s__44366__$1 = s__44366;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__44366__$1);
if(temp__5753__auto__){
var s__44366__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__44366__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__44366__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__44368 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__44367 = (0);
while(true){
if((i__44367 < size__4651__auto__)){
var vec__44376 = cljs.core._nth(c__4650__auto__,i__44367);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44376,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44376,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__44368,id);

var G__44452 = (i__44367 + (1));
i__44367 = G__44452;
continue;
} else {
var G__44453 = (i__44367 + (1));
i__44367 = G__44453;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44368),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__44365(cljs.core.chunk_rest(s__44366__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44368),null);
}
} else {
var vec__44383 = cljs.core.first(s__44366__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44383,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44383,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__44365(cljs.core.rest(s__44366__$2)));
} else {
var G__44457 = cljs.core.rest(s__44366__$2);
s__44366__$1 = G__44457;
continue;
}
}
} else {
