...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49201 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49201(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_49203 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_49203(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_49208 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_49208(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_49209 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_49209(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49217 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49217(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49218 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49218(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__49178,callback){
var map__49179 = p__49178;
var map__49179__$1 = cljs.core.__destructure_map(map__49179);
var input = map__49179__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49179__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49179__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
