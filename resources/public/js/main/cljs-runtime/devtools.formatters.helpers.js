...
var G__42531 = devtools.prefs.pref(v);
v = G__42531;
continue;
} else {
return v;
...
}catch (e42416){var _e__40685__auto__ = e42416;
return false;
}})();
...
}catch (e42420){var _e__40685__auto__ = e42420;
return false;
}})();
...
}catch (e42426){var _e__40685__auto__ = e42426;
return false;
}}
}
});
...
var vec__42442 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42442,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42442,(1),null);
...
return cljs.core.some((function (p1__42471_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42471_SHARP_);
}),template);
});
